<div class="cardLayout box">
    ...
    <div class="Areabutton">
        <button class="btnCardLayoutProfileEdit"><a style="color: white"
                href="{{ route('announcement.show', ['announcement' => $announcement]) }}">{{ __('ui.buttonDetails') }}</a></button>

        <a href="{{ route('announcement.edit', ['announcement' => $announcement]) }}"><button
                class="btnCardLayoutProfile">
        ...
        <a href="">
            <button class="btnCardLayoutProfile">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
