        ...
        <div id="containerFormLogin" class="col-12 col-xl-4">
            ...
            <form action="./login" method="POST">
                ...
                <button type="button" class="BtnAuthGoogle">
                    ...
                    {{-- text --}}
                    <a href="{{route ('google.auth')}}" style="color: white">Continua con Google</a></button>
                <a href="/forgot-password">
                    <p class="pswDimenticata" style="color: black">{{ __('ui.requestPsw') }}</p>
                </a>
                    <p class="vaiARegistrati" style="color: black;margin-top:0px;">Non sei registrato? <a href="/register"><span style="font-weight: 500">Clicca qui</span></p></a>
            </form>
        </div>
    </div>
